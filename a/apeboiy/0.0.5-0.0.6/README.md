# Comparing `tmp/apeboiy-0.0.5.tar.gz` & `tmp/apeboiy-0.0.6.tar.gz`
...
## Comparing `apeboiy-0.0.5.tar` & `apeboiy-0.0.6.tar`
...
### Comparing `apeboiy-0.0.5/LICENSE` & `apeboiy-0.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `apeboiy-0.0.5/PKG-INFO` & `apeboiy-0.0.6/PKG-INFO`
...
### Comparing `apeboiy-0.0.5/pyproject.toml` & `apeboiy-0.0.6/pyproject.toml`
...
### Comparing `apeboiy-0.0.5/src/apeboiy/plyreader/reader.py` & `apeboiy-0.0.6/src/apeboiy/plyreader/reader.py`

 * *Files identical despite different names*

### Comparing `apeboiy-0.0.5/src/apeboiy.egg-info/PKG-INFO` & `apeboiy-0.0.6/src/apeboiy.egg-info/PKG-INFO`
