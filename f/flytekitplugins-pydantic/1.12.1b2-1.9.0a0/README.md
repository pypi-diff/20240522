# Comparing `tmp/flytekitplugins_pydantic-1.12.1b2.tar.gz` & `tmp/flytekitplugins-pydantic-1.9.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flytekitplugins_pydantic-1.12.1b2.tar", last modified: Wed May 22 13:27:16 2024, max compression
+gzip compressed data, was "flytekitplugins-pydantic-1.9.0a0.tar", last modified: Thu Jul 20 18:58:25 2023, max compression
```

## Comparing `flytekitplugins_pydantic-1.12.1b2.tar` & `flytekitplugins-pydantic-1.9.0a0.tar`

### file list

```diff
@@ -1,22 +1,20 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 13:27:16.582364 flytekitplugins_pydantic-1.12.1b2/
--rw-r--r--   0 runner    (1001) docker     (127)     1824 2024-05-22 13:27:16.582364 flytekitplugins_pydantic-1.12.1b2/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      775 2024-05-22 13:26:34.000000 flytekitplugins_pydantic-1.12.1b2/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 13:27:16.578364 flytekitplugins_pydantic-1.12.1b2/flytekitplugins/
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 13:27:16.578364 flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/
--rw-r--r--   0 runner    (1001) docker     (127)      268 2024-05-22 13:26:34.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     2923 2024-05-22 13:26:34.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/basemodel_transformer.py
--rw-r--r--   0 runner    (1001) docker     (127)     1112 2024-05-22 13:26:34.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/commons.py
--rw-r--r--   0 runner    (1001) docker     (127)     6376 2024-05-22 13:26:34.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/deserialization.py
--rw-r--r--   0 runner    (1001) docker     (127)     4839 2024-05-22 13:26:34.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/serialization.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 13:27:16.578364 flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     1824 2024-05-22 13:27:16.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      605 2024-05-22 13:27:16.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-22 13:27:16.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       55 2024-05-22 13:27:16.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-05-22 13:27:16.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/namespace_packages.txt
--rw-r--r--   0 runner    (1001) docker     (127)       34 2024-05-22 13:27:16.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-05-22 13:27:16.000000 flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-22 13:27:16.582364 flytekitplugins_pydantic-1.12.1b2/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     1488 2024-05-22 13:27:07.000000 flytekitplugins_pydantic-1.12.1b2/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-22 13:27:16.578364 flytekitplugins_pydantic-1.12.1b2/tests/
--rw-r--r--   0 runner    (1001) docker     (127)     9418 2024-05-22 13:26:34.000000 flytekitplugins_pydantic-1.12.1b2/tests/test_type_transformer.py
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/PKG-INFO` & `flytekitplugins-pydantic-1.9.0a0/PKG-INFO`
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/README.md` & `flytekitplugins-pydantic-1.9.0a0/README.md`
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/basemodel_transformer.py` & `flytekitplugins-pydantic-1.9.0a0/flytekitplugins/pydantic/basemodel_transformer.py`
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/commons.py` & `flytekitplugins-pydantic-1.9.0a0/flytekitplugins/pydantic/commons.py`
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/deserialization.py` & `flytekitplugins-pydantic-1.9.0a0/flytekitplugins/pydantic/deserialization.py`
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/flytekitplugins/pydantic/serialization.py` & `flytekitplugins-pydantic-1.9.0a0/flytekitplugins/pydantic/serialization.py`
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/PKG-INFO` & `flytekitplugins-pydantic-1.9.0a0/flytekitplugins_pydantic.egg-info/PKG-INFO`
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/flytekitplugins_pydantic.egg-info/SOURCES.txt` & `flytekitplugins-pydantic-1.9.0a0/flytekitplugins_pydantic.egg-info/SOURCES.txt`
...
### Comparing `flytekitplugins_pydantic-1.12.1b2/setup.py` & `flytekitplugins-pydantic-1.9.0a0/setup.py`
