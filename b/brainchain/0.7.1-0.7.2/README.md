# Comparing `tmp/brainchain-0.7.1.tar.gz` & `tmp/brainchain-0.7.2.tar.gz`
...
### Comparing `brainchain-0.7.1/brainchain/webapp/tools.py` & `brainchain-0.7.2/brainchain/webapp/tools.py`
