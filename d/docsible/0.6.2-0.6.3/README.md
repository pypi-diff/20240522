# Comparing `tmp/docsible-0.6.2.tar.gz` & `tmp/docsible-0.6.3.tar.gz`
...
### Comparing `docsible-0.6.2/LICENSE` & `docsible-0.6.3/LICENSE`
...
### Comparing `docsible-0.6.2/PKG-INFO` & `docsible-0.6.3/PKG-INFO`
