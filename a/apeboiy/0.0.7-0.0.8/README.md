# Comparing `tmp/apeboiy-0.0.7.tar.gz` & `tmp/apeboiy-0.0.8.tar.gz`
...
## Comparing `apeboiy-0.0.7.tar` & `apeboiy-0.0.8.tar`
...
### Comparing `apeboiy-0.0.7/LICENSE` & `apeboiy-0.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `apeboiy-0.0.7/PKG-INFO` & `apeboiy-0.0.8/PKG-INFO`
...
### Comparing `apeboiy-0.0.7/pyproject.toml` & `apeboiy-0.0.8/pyproject.toml`
...
### Comparing `apeboiy-0.0.7/src/apeboiy/ply/_reader.py` & `apeboiy-0.0.8/src/apeboiy/ply/_reader.py`

 * *Files identical despite different names*

### Comparing `apeboiy-0.0.7/src/apeboiy.egg-info/PKG-INFO` & `apeboiy-0.0.8/src/apeboiy.egg-info/PKG-INFO`
