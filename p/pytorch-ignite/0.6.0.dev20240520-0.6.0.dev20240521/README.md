# Comparing `tmp/pytorch_ignite-0.6.0.dev20240520.tar.gz` & `tmp/pytorch_ignite-0.6.0.dev20240521.tar.gz`
...
### Comparing `pytorch_ignite-0.6.0.dev20240520/README.md` & `pytorch_ignite-0.6.0.dev20240521/README.md`
...
### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/contrib/handlers/neptune_logger.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/contrib/handlers/neptune_logger.py`
...
### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/contrib/metrics/regression/geometric_mean_absolute_error.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/contrib/metrics/regression/geometric_mean_absolute_error.py`
...
### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/distributed/comp_models/horovod.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/distributed/comp_models/horovod.py`
...
### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/manhattan_distance.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/manhattan_distance.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/maximum_absolute_error.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/maximum_absolute_error.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/mean_absolute_relative_error.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/mean_absolute_relative_error.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/mean_error.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/mean_error.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/mean_normalized_bias.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/mean_normalized_bias.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/median_absolute_error.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/median_absolute_error.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/median_absolute_percentage_error.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/median_absolute_percentage_error.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/median_relative_absolute_error.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/median_relative_absolute_error.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/pearson_correlation.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/pearson_correlation.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/r2_score.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/r2_score.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/regression/wave_hedges_distance.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/regression/wave_hedges_distance.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/roc_auc.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/roc_auc.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/root_mean_squared_error.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/root_mean_squared_error.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/running_average.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/running_average.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/ssim.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/ssim.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/metrics/top_k_categorical_accuracy.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/metrics/top_k_categorical_accuracy.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/ignite/utils.py` & `pytorch_ignite-0.6.0.dev20240521/ignite/utils.py`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/pyproject.toml` & `pytorch_ignite-0.6.0.dev20240521/pyproject.toml`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/pytorch_ignite.egg-info/PKG-INFO` & `pytorch_ignite-0.6.0.dev20240521/pytorch_ignite.egg-info/PKG-INFO`
...
### Comparing `pytorch_ignite-0.6.0.dev20240520/pytorch_ignite.egg-info/SOURCES.txt` & `pytorch_ignite-0.6.0.dev20240521/pytorch_ignite.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/setup.cfg` & `pytorch_ignite-0.6.0.dev20240521/setup.cfg`

 * *Files identical despite different names*

### Comparing `pytorch_ignite-0.6.0.dev20240520/setup.py` & `pytorch_ignite-0.6.0.dev20240521/setup.py`
