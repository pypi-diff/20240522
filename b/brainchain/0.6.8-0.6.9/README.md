# Comparing `tmp/brainchain-0.6.8.tar.gz` & `tmp/brainchain-0.6.9.tar.gz`
...
### Comparing `brainchain-0.6.8/brainchain/webapp/namespaces.py` & `brainchain-0.6.9/brainchain/webapp/namespaces.py`
